...
sudo pacman -Sy git man-db zed vim ghostty starship fish bottom eza bat fastfetch flatpak flatseal ollama opencode steam lib32-nvidia-utils proton-vpn-gtk-app gnome-keyring ttf-hack-nerd ttf-input-nerd --noconfirm
